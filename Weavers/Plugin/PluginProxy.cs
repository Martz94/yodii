...
namespace Weavers.Plugin
{
    ...
    sealed class PluginProxy : PluginProxyBase, IPluginProxy, IYodiiEngineBase
    {
        ...
        IConfigurationManager IYodiiEngineBase.Configuration => _engine.Configuration;

        ILiveInfo IYodiiEngineBase.LiveInfo => _engine.LiveInfo;
